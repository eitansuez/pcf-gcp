...
Finally, the terraform script creates your Ops Manager image, an Ops Manager service account, and most importantly, Ops Manager VM instance, which you'll interact with in the next lab.
