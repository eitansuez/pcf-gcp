...
* Select the default region where resources should be created: {region}. This should be the region that the class will be delivered in.  A list of GCP regions and zones can be found https://cloud.google.com/compute/docs/regions-zones/regions-zones[here^].
