...
Four buckets should have been created for you by the terraform script:  gcp-buildpacks, gcp-droplets, gcp-packages, and gcp-resources, as shown in the screenshot below.
